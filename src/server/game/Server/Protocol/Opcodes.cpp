...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FAILED_PLAYER_CONDITION,                          STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FORGE_MASTER_SET,                                 STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSPECT_RATED_BG_STATS,                           STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_SEARCH_RESULT,                                STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_CONTENTS,                                    STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ON_MONSTER_MOVE_TRANSPORT,                        STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PARTY_MEMBER_FULL_STATE,                          STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PERIODIC_AURA_LOG,                                STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SUMMON_RAID_MEMBER_VALIDATE_FAILED,               STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_DISPEL_LOG,                                 STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SUSPEND_TOKEN,                                    STATUS_NEVER);
...
#define DEFINE_MSG_OPCODE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_MSG_OPCODE_HANDLER(MSG_AUCTION_HELLO,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_CHANNEL_START,                                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    DEFINE_MSG_OPCODE_HANDLER(MSG_CHANNEL_UPDATE,                                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    DEFINE_MSG_OPCODE_HANDLER(MSG_CORPSE_QUERY,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseQueryOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_INSPECT_ARENA_TEAMS,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleInspectArenaTeamsOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_LIST_STABLED_PETS,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListStabledPetsOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MINIMAP_PING,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMinimapPingOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_CHARM_TELEPORT_CHEAT,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_FALL_LAND,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_HEARTBEAT,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_JUMP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_FACING,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_PITCH,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_ASCEND,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_BACKWARD,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_DESCEND,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_FORWARD,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_PITCH_DOWN,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_PITCH_UP,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,                           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_SWIM,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_TURN_LEFT,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_TURN_RIGHT,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_ASCEND,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_PITCH,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_STRAFE,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_TURN,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TELEPORT,                                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TELEPORT_ACK,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAck);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TELEPORT_CHEAT,                               STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TIME_SKIPPED,                                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TOGGLE_COLLISION_CHEAT,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_WORLDPORT_ACK,                                STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_NOTIFY_PARTY_SQUELCH,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_MSG_OPCODE_HANDLER(MSG_PARTY_ASSIGNMENT,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePartyAssignmentOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_PETITION_DECLINE,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionDeclineOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_PETITION_RENAME,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionRenameOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_QUERY_NEXT_MAIL_TIME,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryNextMailTime);
    DEFINE_MSG_OPCODE_HANDLER(MSG_QUEST_PUSH_RESULT,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestPushResult);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_READY_CHECK,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_READY_CHECK_CONFIRM,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_READY_CHECK_FINISHED,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckFinishedOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_TARGET_UPDATE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidTargetUpdateOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RANDOM_ROLL,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRandomRollOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_SAVE_GUILD_EMBLEM,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSaveGuildEmblemOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_SET_DUNGEON_DIFFICULTY,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_TABARDVENDOR_ACTIVATE,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTabardVendorActivateOpcode);
    DEFINE_MSG_OPCODE_HANDLER(MSG_TALENT_WIPE_CONFIRM,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTalentWipeConfirmOpcode);
